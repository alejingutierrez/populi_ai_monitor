...
- 7000 posts de ejemplo (6000 Sep–Dic 2025 + 1000 Ene 1–20, 2026) con coordenadas en Puerto Rico, sentimiento, tema, plataforma y estructura de cluster/subcluster/microcluster.
...
- `src/data/localPosts.ts` datos mock (7000 posts) con generador determinista.
