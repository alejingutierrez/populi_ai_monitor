...
const buildGeoJson = (insights: CityInsight[]): GeoCollection => ({
  ...
  features: insights.map((insight) => ({
    ...
    properties: {
      ...
      sentimentIndex: insight.sentimentIndex,
...
const parseInsightFromFeature = (
  ...
  return {
    ...
    reach: Number(props.reach ?? 0),
    engagement: Number(props.engagement ?? 0),
    engagementRate: Number(props.engagementRate ?? 0),
    sentimentIndex: Number(props.sentimentIndex ?? 0),
